...
## Hardware Required
- [SLWSTK6006A](https://www.silabs.com/development-tools/wireless/efr32xg21-wireless-starter-kit?tab=overview)
- [BRD4181A or BRD4181B - EFR32MG21](https://www.silabs.com/development-tools/wireless/slwrb4181b-efr32xg21-wireless-gecko-radio-board) if you already have an MB4002A main board
- [Si-MB4002A Main Board with on-board joystick] (https://www.silabs.com/development-tools/wireless/wireless-pro-kit-mainboard?tab=overview)
...
![example project & demos tab](images/example_projects_and_demos.png)
...
## How it Works
More information about how a basic BLE HID keyboard works can be found [here](../bluetooth_hid_keyboard/readme.md). This example adds on top of the simple HID keyboard example to show how to have the HID mouse and keyboard in a single report map.
...
(Appendix E.10: Report Descriptor (Mouse)). The keyboard report map is explained in [BLE HID keyboard example](../bluetooth_hid_keyboard/readme.md) as well.
