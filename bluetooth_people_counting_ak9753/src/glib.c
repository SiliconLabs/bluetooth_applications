...
static uint8_t glib_frame_buffer[(SSD1306_DISPLAY_WIDTH
...
*
*  @param pContext
*  Pointer to a glib_context_t which holds the foreground color and clipping
*   region
*  @param x
*  X-coordinate
*  @param y
...
*  Returns GLIB_OK on success, or else error code
******************************************************************************/
glib_status_t glib_draw_char(glib_context_t *pContext,
                             char my_char,
                             int32_t x,
                             int32_t y)
{
...
*  Returns GLIB_OK on success, or else error code
******************************************************************************/
glib_status_t glib_draw_rectangle(glib_context_t *pContext,
                                  uint8_t x1,
                                  uint8_t y1,
                                  uint8_t x2,
                                  uint8_t y2)
...
*
*  @param pContext
*  Pointer to a glib_context_t in which the circle is drawn. The circle is drawn
*   using
...
*  Returns GLIB_OK on success, or else error code
******************************************************************************/
glib_status_t glib_draw_circle(glib_context_t *pContext,
                               uint8_t par_x,
                               uint8_t par_y,
                               uint8_t par_r)
{
...
{
  return ((ssd1306_draw(glib_frame_buffer)
...
{
  return ((ssd1306_set_invert_color()
...
{
  return ((ssd1306_set_normal_color()
           == SL_STATUS_OK) ? GLIB_OK : GLIB_ERROR_IO);
}
...
{
  return ((ssd1306_set_contrast(value)
           == SL_STATUS_OK) ? GLIB_OK : GLIB_ERROR_IO);
}
...
{
  return ((ssd1306_scroll_right(start_page_addr, end_page_addr)
           == SL_STATUS_OK) ? GLIB_OK : GLIB_ERROR_IO);
}
...
{
  return ((ssd1306_scroll_left(start_page_addr, end_page_addr)
           == SL_STATUS_OK) ? GLIB_OK : GLIB_ERROR_IO);
}
...
{
  return ((ssd1306_scroll_diag_right(start_page_addr, end_page_addr)
           == SL_STATUS_OK) ? GLIB_OK : GLIB_ERROR_IO);
}
...
glib_status_t glib_scroll_diag_left(uint8_t start_page_addr,
                                    uint8_t end_page_addr)
{
  return ((ssd1306_scroll_diag_left(start_page_addr, end_page_addr)
           == SL_STATUS_OK) ? GLIB_OK : GLIB_ERROR_IO);
}
...
{
  return ((ssd1306_enable_display(on)
           == SL_STATUS_OK) ? GLIB_OK : GLIB_ERROR_IO);
}
