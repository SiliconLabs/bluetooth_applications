                                      ...
                                      uint8_t end_page_addr)
{
  ...
  uint8_t cmd_buff[10] = {
    ...
    SSD1306_VERTICAL_AND_RIGHT_HORIZONTAL_SCROLL,   //  0x29 Vertical and Right
                                                    //   Horizontal Scroll
    0x00,                               //  Dummy byte
    start_page_addr,                    //  Set start page address
    0x00,                               //  Set time interval between each
                                        //   scroll
    end_page_addr,                      //  Set end page address
                                     ...
                                     uint8_t end_page_addr)
{
  ...
  uint8_t cmd_buff[10] = {
    ...
    0x00,                               //  Set No. of rows in top fixed area
    SSD1306_DISPLAY_HEIGHT,             //  Set No. of rows in scroll area
    SSD1306_VERTICAL_AND_LEFT_HORIZONTAL_SCROLL,   //  0x2A Vertical and Left
                                                   //   Horizontal Scroll
    0x00,                               //  Dummy byte
    start_page_addr,                    //  Set start page address
    0x00,                               //  Set time interval between each
