 ...
 ******************************************************************************/
sl_status_t client_nvm3_set_click_noise_status(bool enable)
{
  uint8_t data = enable ? 1:0;
  Ecode_t err;
 ...
 ******************************************************************************/
sl_status_t client_nvm3_set_alarm_threshold(float threshold)
{
  Ecode_t err;
 ...
 ******************************************************************************/
bool client_nvm3_get_click_noise_status(void)
{
  Ecode_t err;
 ...
 ******************************************************************************/
float client_nvm3_get_alarm_threshold(void)
{
  Ecode_t err;
  float threshold;
...
{
  cfg->alarm_threshold = client_nvm3_get_alarm_threshold();
  cfg->click_noise_status = client_nvm3_get_click_noise_status();
  cfg->notification_status = client_nvm3_get_notification_status();
}
