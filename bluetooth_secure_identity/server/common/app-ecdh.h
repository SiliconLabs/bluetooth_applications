...
typedef enum {
  ...
  readingCoords,
  writingCoords,
  discoverTestDataService,
  discoverServerDataOutCharacteristic,
  discoverNonceCharacteristic,
  readServerDataOutCharacteristic,
  running
} ConnState;*/
...
/*
 * maybe it's time to think about splitting this up into multiple structs since many of these fields are not actually related to ECDH
 * */
