/***************************************************************************//**
 * @file fingeprint_oled.c
 * @brief fingerprint oled source file.
 *******************************************************************************
 * # License
                             ...
                             const char *string_lower)
{
  ...
  string_lower_len = strlen(string_lower);
  ...
  data_x_start = (64 - 3 * string_lower_len - (string_lower_len - 1)) / 2;
  glib_draw_string(&glib_context, string_lower, data_x_start, 44);
...
/***************************************************************************//**
 * Fingerprint Door Lock Oled Application Initialize.
 ******************************************************************************/
void fingerprint_oled_init(void)
{
  ...
  glib_draw_line(&glib_context, 0, 35, 63, 35, GLIB_WHITE);
  glib_update_display();
  fingerprint_oled_update(" LOCKED", "DISCONNECTED");
}
