...
// Glucose feature
#define SL_BT_BGM_FEATURE_MULTI_BOND_SUPPORT true // Multiple-Bond Supported
...
#define PROCEDURE_ALREADY_IN_PROCESSED 0x80 /** <Procedure Already In Progress*/
...
void sl_bt_bgm_report_records_within_range(uint8_t connection,
                             uint8_t filter_type,uint16_t low,uint16_t high);
/**************************************************************************//**
