...
static sl_simple_timer_t bgm_fast_adv_timer;
 ...
 *****************************************************************************/
static void sl_bgm_fast_adv_timeout(sl_simple_timer_t *handle,
                                void *data)
{
  ...
  (void)&data;
  // Stop timer.
  sc = sl_simple_timer_stop(&bgm_fast_adv_timer);
  if(sc != SL_STATUS_OK){
...
void sl_bt_start_adv(void)
{
  ...
  if(fast_adv){
    ...
    sl_simple_timer_start(&bgm_fast_adv_timer,
...
void sl_bt_create_user_adv(void)
{
  ...
  const uint8_t value[] = {0x02,0x01,0x06,0x03,0x03,0x08,0x18,0x0B,0x08,0x73,\
                           0x69,0x6C,0x61,0x62,0x73,0x2D,0x62,0x67,0x6D,0x03,\
