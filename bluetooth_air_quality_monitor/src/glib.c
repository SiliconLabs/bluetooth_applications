 ...
 *    Returns GLIB_OK on success, or else error code
 ******************************************************************************/
glib_status_t glib_draw_string(glib_context_t *pContext,
                               const char* str,
                               int32_t x0,
                               int32_t y0)
{
 ...
 *    Note that GLIB defines a default font in glib.c.
 ...
 *    Returns GLIB_OK on success, or else error code
 ******************************************************************************/
glib_status_t glib_draw_line(glib_context_t *pContext,
                             uint8_t x1,
                             uint8_t y1,
                             uint8_t x2,
                             uint8_t y2)
 ...
 *
 *  @param[in] pContext
 *    Pointer to a glib_context_t in which the circle is drawn. 
 *    The circle is drawn using the foreground color.
 *
 *  @param[in] par_x
 *    Center x-coordinate
 *
