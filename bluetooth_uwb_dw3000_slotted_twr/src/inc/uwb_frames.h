...
#define FRAME_CTRLP                 (FRAME_CONTROL_BYTES + FRAME_SEQ_NUM_BYTES \
                                     + FRAME_PANID) /* 5 */
#define FRAME_CTRL_AND_ADDRESS_L \
  (FRAME_DEST_ADDRESS_L          \
   + FRAME_SOURCE_ADDRESS_L + FRAME_CTRLP) /* 21 bytes
                                            * for 64-bit addresses)
                                            */
#define FRAME_CTRL_AND_ADDRESS_S \
  (FRAME_DEST_ADDRESS_S          \
   + FRAME_SOURCE_ADDRESS_S + FRAME_CTRLP) /*
                                            *   9 bytes
                                            *   for 16-bit addresses)
                                            */
#define FRAME_CTRL_AND_ADDRESS_LS \
  (FRAME_DEST_ADDRESS_L           \
   + FRAME_SOURCE_ADDRESS_S + FRAME_CTRLP)  /*   15 bytes for 1
                                             *   16-bit address and
                                             *   1 64-bit address)
                                             */
#define MAX_USER_PAYLOAD_STRING_LL \
  (STANDARD_FRAME_SIZE             \
   - FRAME_CTRL_AND_ADDRESS_L - FRAME_CRC)  /* 127 - 21 - 2 = 104 */
#define MAX_USER_PAYLOAD_STRING_SS \
  (STANDARD_FRAME_SIZE             \
   - FRAME_CTRL_AND_ADDRESS_S - FRAME_CRC) /* 127 - 9 - 2 = 116 */
#define MAX_USER_PAYLOAD_STRING_LS \
  (STANDARD_FRAME_SIZE             \
   - FRAME_CTRL_AND_ADDRESS_LS - FRAME_CRC)/* 127 - 15 - 2 = 110 */
