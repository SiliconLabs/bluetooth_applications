...
void maxm86161_get_irq_status(maxm86161_int_t *int_status)
{
  ...
  maxm86161_i2c_read_from_register(MAXM86161_REG_IRQ_STATUS1, &int_status_value);
  ...
  maxm86161_i2c_read_from_register(MAXM86161_REG_IRQ_STATUS2, &int_status_value);
...
void maxm86161_read_samples_in_fifo(maxm86161_fifo_queue_t *queue)
{
  ...
  bool task_started = false; // we only start to push to queue incase we meet perfect sample ( means PPG1, PPG2, PPG3)
