...
#define MAXM86161_HRM_ERROR_PARAM3_OUT_OF_RANGE \
  (MAXM86161_HRM_ERROR_PARAM0_OUT_OF_RANGE - 2)
#define MAXM86161_HRM_ERROR_PARAM4_OUT_OF_RANGE \
  (MAXM86161_HRM_ERROR_PARAM0_OUT_OF_RANGE - 3)
#define MAXM86161_HRM_ERROR_PARAM5_OUT_OF_RANGE \
  (MAXM86161_HRM_ERROR_PARAM0_OUT_OF_RANGE - 4)
#define MAXM86161_HRM_ERROR_PARAM6_OUT_OF_RANGE \
  (MAXM86161_HRM_ERROR_PARAM0_OUT_OF_RANGE - 5)
#define MAXM86161_HRM_ERROR_PARAM7_OUT_OF_RANGE \
  (MAXM86161_HRM_ERROR_PARAM0_OUT_OF_RANGE - 6)
#define MAXM86161_HRM_ERROR_PARAM8_OUT_OF_RANGE \
  (MAXM86161_HRM_ERROR_PARAM0_OUT_OF_RANGE - 7)
#define MAXM86161_HRM_ERROR_PARAM9_OUT_OF_RANGE \
  (MAXM86161_HRM_ERROR_PARAM0_OUT_OF_RANGE - 8)
...
// Include all HRM bits
#define MAXM86161_HRM_STATUS_HRM_MASK                       0x00ff
// Used to inform to process the SpO2 frame.
#define SPO2_STATUS_PROCESS_SPO2_FRAME                      1
...
// Restart DC sensing.
#define HRM_DC_SENSING_RESTART                              0x01
...
// BPF_Active_Flag bit
#define HRM_BPF_ACTIVE                                      0x01
// BPF_Active_Flag bit
#define SpO2_RED_BPF_ACTIVE                                 0x02
// BPF_Active_Flag bit
...
typedef struct mamx86161_hrm_data
{
  ...
  uint16_t hrm_raw_ps;
  uint16_t hrm_ps;
  // This is useful for displaying the waveform
  uint16_t hrm_interpolated_ps[MAXM86161_HRM_MAX_INTERPOLATION_FACTOR];
...
{
  /**< HRM_DATA_SIZE bytes allocated */
  uint8_t hrm[MAXM86161_HRM_HRM_DATA_SIZE];
 ...
 *****************************************************************************/
int32_t maxm86161_hrm_initialize(maxm86161_data_storage_t *data,
                                 maxm_hrm_handle_t **handle);
 ...
 *
 * @param[out] hrm_data
 *  Optional pointer to a si117xhrmData_t structure where this function will
 *   return
