...
void oled_app_init(void)
{
  ...
  /* Use Narrow font */
  glib_draw_string(&glib_context, "THERMOSTAT", 15, 0);
                 ...
                 float hysteresis)
{
  ...
  glib_draw_string(&glib_context, number_str, 28, 11);

  snprintf(number_str, sizeof(number_str), "%.1f %c", humidity, '%');

  glib_draw_string(&glib_context, number_str, 28, 21);
  ...
  glib_draw_string(&glib_context, number_str, 0, 32);
